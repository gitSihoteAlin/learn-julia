...
# ╔═╡ 18bb6cee-f14c-485a-bb3b-28b24a94241c
using DifferentialEquations, ParameterizedFunctions, Plots

# ╔═╡ d0d428f0-cbca-4129-8d03-9c1aec282439
lorenz = @ode_def begin                  # define the system
	    dx = σ*(y - x);  dy = x*(ρ - z) - y; dz = x*y - β*z
	 end σ ρ β

# ╔═╡ 41ead23b-7c5c-46ff-a917-d5db5627869d
u0=[1.,1.,-1.]; tspan=(0.,100.); p=[10.,28.,9/3];  # initial conds., timespan and parms.

# ╔═╡ 8d6cd946-64d8-4a3c-91ba-3e4f5454aefa
prob = ODEProblem(lorenz, u0, tspan, p)  # define the problem

# ╔═╡ 0c9f8949-9e46-4e1c-a893-8a0169f395de
sol0 = solve(prob, reltol=1e-9)          # solve it

# ╔═╡ c373be5a-3f35-4ca6-9a1a-6b372b1e9c60
...
manifest_format = "2.0"
project_hash = "86953b3d146ed0e51f504a2f867ca6e1dc5b6788"
...
git-tree-sha1 = "7970554136544662613195dc5adc61e5450cfd4f"
...
git-tree-sha1 = "e802ec3733e8c16dd6b4683b178c4337b4565fcd"
...
git-tree-sha1 = "83cf58f93b818397c88c090b01d3681a9be04994"
...
git-tree-sha1 = "b8fdec0ae84517d87bada8d6f01d9cf8f0c4c3ae"
...
deps = ["DataStructures", "DiffEqBase", "DocStringExtensions", "Latexify", "LinearAlgebra", "ModelingToolkit", "ModelingToolkitBase", "Reexport", "SciMLBase", "SymbolicUtils", "Symbolics"]
git-tree-sha1 = "a09136faf71469ce2545949c8466ab46f3878cb7"
